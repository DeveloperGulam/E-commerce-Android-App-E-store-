...
import com.dattaprabodhinee.estore.databinding.CategorySliderBinding;
...
public class CategorySliderAdapter extends RecyclerView.Adapter<CategorySliderAdapter.SliderViewHolder> {
    ...
    public CategorySliderAdapter(Context context, ArrayList<CategoriesModel> list) {
    ...
    public void onBindViewHolder(@NonNull SliderViewHolder holder, int position) {
        ...
        Glide.with(context).load(BASEURL + model.getCategory_img()).placeholder(R.drawable.fav).error(R.drawable.fav).into(holder.binding.categorySliderImg);
        holder.binding.categorySliderText.setText(model.getName());
    ...
    public  class SliderViewHolder extends RecyclerView.ViewHolder {
        CategorySliderBinding binding;
        public SliderViewHolder(@NonNull View itemView) {
            super(itemView);
            binding = CategorySliderBinding.bind(itemView);
        }
    }
}
